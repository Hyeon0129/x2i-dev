---
title: "Installing Tenstorrent SDKs – TT-Metal"
date: "2025-03-15"
category: "Guides"
slug: "installing_ttmetal"
thumbnail: "/images/thumbnails/guide-installing-ttemtal.png"
...
- <strong>TT-NN</strong>: A library of optimized neural network operators with a PyTorch-like API.
...
If you have not set up the basic hardware environment yet, please check the setup instructions [here](/blog/guides/tenstorrent_npu_setup_guide) before proceeding.
...
#### Step 3: Step 3: Build TT-Metal and Set Up Virtual Environment
...
![tt-nn-test](/images/posts/guides/installing_tt_metal/ttnn_test.png)
...
Before proceeding, make sure you’ve completed [Step 1: Clone the Repository](#step-1%3A-clone-the-repository).
...
![ttnn_examples](/images/posts/guides/installing_tt_metal/ttnn_examples.png)
